...
export class SignupComponent implements OnInit {
  ...
  requestOTP() {
    ...
    this.afAuth.signInWithPhoneNumber('+91' + String(this.form.value.phoneNumber), this.windowRef.recaptchaVerifier)
  ...
  verifyOtp() {
    ...
    .then(result => {
      ...
      this.apiAuthService.register(payload).then(res => {
        this.router.navigate(['/signup/address/' + this.form.value.phoneNumber])
