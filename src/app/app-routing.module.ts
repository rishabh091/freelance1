...
const routes: Routes = [
  ...
  { path: 'addOrder/:tableNumber', component: AddOrderComponent, canActivate: [AuthGuard] },
  { path: 'addOrder/:tableNumber/id/:id', component: AddOrderComponent, canActivate: [AuthGuard] },
